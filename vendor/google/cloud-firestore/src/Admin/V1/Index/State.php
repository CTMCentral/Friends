...
use Google\Cloud\Firestore\Admin\V1\Index_State;
 ...
 *
 * Protobuf type <code>google.firestore.adminSubCommand.v1.Index.State</code>
 */
class State
{
    /**
...
class_alias(State::class, Index_State::class);
