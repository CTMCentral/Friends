...
use Google\Cloud\Firestore\Admin\V1\Index_QueryScope;
 ...
 *
 * Protobuf type <code>google.firestore.adminSubCommand.v1.Index.QueryScope</code>
 */
class QueryScope
{
    /**
...
class_alias(QueryScope::class, Index_QueryScope::class);
