 ...
 *
 * Protobuf type <code>google.firestore.adminSubCommand.v1.Index.IndexField.ArrayConfig</code>
 */
class ArrayConfig
{
    /**
...
class_alias(ArrayConfig::class, Index_IndexField_ArrayConfig::class);
