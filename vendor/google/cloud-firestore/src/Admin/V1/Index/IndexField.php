 ...
 *
 * Generated from protobuf message <code>google.firestore.adminSubCommand.v1.Index.IndexField</code>
 */
class IndexField extends Message
{
     ...
     * comparing using =, <, <=, >, >=.
     *
     * Generated from protobuf field <code>.google.firestore.adminSubCommand.v1.Index.IndexField.Order order = 2;</code>
     * @return int
     */
     ...
     * Indicates that this field supports operations on `array_value`s.
     *
     * Generated from protobuf field <code>.google.firestore.adminSubCommand.v1.Index.IndexField.ArrayConfig array_config = 3;</code>
     * @return int
     */
