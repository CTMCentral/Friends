 ...
 * Unit of work is generic and must be interpreted based on where [Progress][google.firestore.adminSubCommand.v1.Progress]
 * is used.
 *
 * Generated from protobuf message <code>google.firestore.adminSubCommand.v1.Progress</code>
 */
