...
class WriteBatch
{
    ...
    public function create($document, array $fields, array $options = [])
    {
        ...
        [$fields, $sentinels, $metadata] = $this->filterFields($fields);
    ...
    private function filterFieldsRecursive(
        ...
        foreach ($fields as $key => $value) {
            ...
            if (is_array($value) && !empty($value)) {
                [$fields[$key], $sentinels, $metadata] = $this->filterFieldsRecursive(
                    $value,
                    $sentinels,
                    $metadata,
                    $inputPaths,
    ...
    public function update($document, array $data, array $options = [])
    {
        ...
        [$fields, $sentinels, $metadata] = $this->filterFields($fields, $paths);
