...
use Google\Cloud\Firestore\V1beta1\Target\DocumentsTarget;
use Google\Cloud\Firestore\V1beta1\Target\QueryTarget;
...
class Target extends Message
{
     ...
     *
     *     @type QueryTarget $query
     *           A target specified by a query.
     *     @type DocumentsTarget $documents
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.Target.QueryTarget query = 2;</code>
     * @param QueryTarget $var
     * @return $this
     */
    public function setQuery($var)
    {
        GPBUtil::checkMessage($var, Target_QueryTarget::class);
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.Target.DocumentsTarget documents = 3;</code>
     * @param DocumentsTarget $var
     * @return $this
     */
    public function setDocuments($var)
    {
        GPBUtil::checkMessage($var, Target_DocumentsTarget::class);
