...
use Google\Iam\Admin\V1\Permission_PermissionLaunchStage;
use UnexpectedValueException;

/**
 * A stage representing a permission's lifecycle phase.
 *
 * Protobuf type <code>google.iam.adminSubCommand.v1.Permission.PermissionLaunchStage</code>
 */
...
class_alias(PermissionLaunchStage::class, Permission_PermissionLaunchStage::class);
