 ...
 *
 * Generated from protobuf message <code>google.iam.adminSubCommand.v1.Role</code>
 */
class Role extends Message
{
     ...
     *
     * Generated from protobuf field <code>.google.iam.adminSubCommand.v1.Role.RoleLaunchStage stage = 8;</code>
     */
    private $stage = 0;
    /**
     ...
     *           Optional. A human-readable description for the role.
     *     @type string[]|RepeatedField $included_permissions
     *           The names of the permissions this role grants when bound in an IAM policy.
     *     @type int                    $stage
     *           The current launch stage of the role. If the `ALPHA` launch stage has been
     *           selected for a role, the `stage` field will not be included in the
    ...
    {
        GPBUtil::checkEnum($var, Role_RoleLaunchStage::class);
        $this->stage = $var;
