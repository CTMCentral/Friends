...
use Google\Iam\Admin\V1\ListServiceAccountKeysRequest_KeyType;
 ...
 * of keys.
 *
 * Protobuf type <code>google.iam.adminSubCommand.v1.ListServiceAccountKeysRequest.KeyType</code>
 */
class KeyType
{
    /**
...
class_alias(KeyType::class, ListServiceAccountKeysRequest_KeyType::class);
