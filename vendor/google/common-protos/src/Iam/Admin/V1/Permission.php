 ...
 *
 * Generated from protobuf message <code>google.iam.adminSubCommand.v1.Permission</code>
 */
class Permission extends Message
{
     ...
     *
     * Generated from protobuf field <code>.google.iam.adminSubCommand.v1.Permission.PermissionLaunchStage stage = 5;</code>
     */
    private $stage = 0;
    /**
     * The current custom role support level.
     *
     * Generated from protobuf field <code>.google.iam.adminSubCommand.v1.Permission.CustomRolesSupportLevel custom_roles_support_level = 6;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, Permission_PermissionLaunchStage::class);
        $this->stage = $var;
    ...
    {
        GPBUtil::checkEnum($var, Permission_CustomRolesSupportLevel::class);
