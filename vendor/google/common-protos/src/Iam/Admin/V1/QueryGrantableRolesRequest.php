 ...
 *
 * Generated from protobuf message <code>google.iam.adminSubCommand.v1.QueryGrantableRolesRequest</code>
 */
class QueryGrantableRolesRequest extends Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.google.iam.adminSubCommand.v1.RoleView view = 2;</code>
     */
    private $view = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, RoleView::class);
        $this->view = $var;
