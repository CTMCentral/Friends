...
class SystemParameters extends Message
{
     ...
     *
     *     @type SystemParameterRule[]|RepeatedField $rules
     *           Define system parameters.
     *           The parameters defined here will override the default parameters
     *           implemented by the system. If this field is missing from the service
     *           config, default system parameters will be used. Default system parameters
     ...
     * Generated from protobuf field <code>repeated .google.api.SystemParameterRule rules = 1;</code>
     *
     * @param SystemParameterRule[]|RepeatedField $var
     * @return $this
     */
    public function setRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, SystemParameterRule::class);
        $this->rules = $arr;
