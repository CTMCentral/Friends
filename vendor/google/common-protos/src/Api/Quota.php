...
class Quota extends Message
{
     ...
     *
     *     @type QuotaLimit[]|RepeatedField $limits
     *           List of `QuotaLimit` definitions for the service.
     *           Used by metric-based quotas only.
     *     @type MetricRule[]|RepeatedField $metric_rules
     *           List of `MetricRule` definitions, each one mapping a selected method to one
     *           or more metrics.
     *           Used by metric-based quotas only.
     * }
     ...
     * Generated from protobuf field <code>repeated .google.api.QuotaLimit limits = 3;</code>
     *
     * @param QuotaLimit[]|RepeatedField $var
     * @return $this
     */
    public function setLimits($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, QuotaLimit::class);
        $this->limits = $arr;
     ...
     * Generated from protobuf field <code>repeated .google.api.MetricRule metric_rules = 4;</code>
     *
     * @param MetricRule[]|RepeatedField $var
     * @return $this
     */
    public function setMetricRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, MetricRule::class);
