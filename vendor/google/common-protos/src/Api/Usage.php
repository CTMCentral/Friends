...
class Usage extends Message
{
     ...
     *
     *     @type string[]|RepeatedField    $requirements
     *           Requirements that must be satisfied before a consumer project can use the
     *           service. Each requirement is of the form <service.name>/<requirement-id>;
     *           for example 'serviceusage.googleapis.com/billing-enabled'.
     *     @type UsageRule[]|RepeatedField $rules
     *           A list of usage rules that apply to individual API methods.
     *           **NOTE:** All service configuration rules follow "last one wins" order.
     ...
     * Generated from protobuf field <code>repeated .google.api.UsageRule rules = 6;</code>
     *
     * @param UsageRule[]|RepeatedField $var
     * @return $this
     */
    public function setRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, UsageRule::class);
        $this->rules = $arr;
