...
class SystemParameterRule extends Message
{
     ...
     *           methods in all APIs.
     *           Refer to [selector][google.api.DocumentationRule.selector] for syntax details.
     *     @type SystemParameter[]|RepeatedField $parameters
     *           Define parameters. Multiple names may be defined for a parameter.
     *           For a given method call, only one of them should be used. If multiple
     *           names are used the behavior is implementation-dependent.
     *           If none of the specified names are present the behavior is
     ...
     * Generated from protobuf field <code>repeated .google.api.SystemParameter parameters = 2;</code>
     *
     * @param SystemParameter[]|RepeatedField $var
     * @return $this
     */
    public function setParameters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, SystemParameter::class);
        $this->parameters = $arr;
