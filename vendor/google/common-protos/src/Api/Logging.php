...
use Google\Api\Logging\LoggingDestination;
...
class Logging extends Message
{
     ...
     *
     *     @type LoggingDestination[]|RepeatedField $producer_destinations
     *           Logging configurations for sending logs to the producer project.
     *           There can be multiple producer destinations, each one must have a
     *           different monitored resource type. A log can be used in at most
     *           one producer destination.
     *     @type LoggingDestination[]|RepeatedField $consumer_destinations
     *           Logging configurations for sending logs to the consumer project.
     *           There can be multiple consumer destinations, each one must have a
     *           different monitored resource type. A log can be used in at most
     *           one consumer destination.
     ...
     * Generated from protobuf field <code>repeated .google.api.Logging.LoggingDestination producer_destinations = 1;</code>
     *
     * @param LoggingDestination[]|RepeatedField $var
     * @return $this
     */
    public function setProducerDestinations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, LoggingDestination::class);
