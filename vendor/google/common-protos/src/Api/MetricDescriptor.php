...
use Google\Api\MetricDescriptor\MetricDescriptorMetadata;
...
class MetricDescriptor extends Message
{
     ...
     *               "external.googleapis.com/prometheus/up"
     *               "appengine.googleapis.com/http/server/response_latencies"
     *     @type LabelDescriptor[]|RepeatedField $labels
     *           The set of labels that can be used to describe a specific
     *           instance of this metric type. For example, the
     *           `appengine.googleapis.com/http/server/response_latencies` metric
     *           type has a label for the HTTP response code, `response_code`, so
     ...
     *           This field is optional but it is recommended to be set for any metrics
     *           associated with user-visible concepts, such as Quota.
     *     @type MetricDescriptorMetadata $metadata
     *           Optional. Metadata which can be used to guide usage of the metric.
     ...
     * Generated from protobuf field <code>repeated .google.api.LabelDescriptor labels = 2;</code>
     *
     * @param LabelDescriptor[]|RepeatedField $var
     * @return $this
     */
    public function setLabels($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, LabelDescriptor::class);
        $this->labels = $arr;
    ...
    {
        GPBUtil::checkEnum($var, MetricDescriptor_MetricKind::class);
    ...
    {
        GPBUtil::checkEnum($var, MetricDescriptor_ValueType::class);
        $this->value_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.api.MetricDescriptor.MetricDescriptorMetadata metadata = 10;</code>
     * @param MetricDescriptorMetadata $var
     * @return $this
     */
    public function setMetadata($var)
    {
        GPBUtil::checkMessage($var, MetricDescriptor_MetricDescriptorMetadata::class);
        $this->metadata = $var;
