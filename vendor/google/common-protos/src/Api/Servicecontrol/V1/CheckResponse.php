...
use Google\Api\Servicecontrol\V1\CheckResponse\CheckInfo;
...
class CheckResponse extends Message
{
     ...
     *           The current service rollout id used to process the request.
     *     @type CheckError[]|RepeatedField $check_errors
     *           Indicate the decision of the check.
     *           If no check errors are present, the service should process the operation.
     *           Otherwise the service should use the list of errors to determine the
     *           appropriate action.
     ...
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.CheckError check_errors = 2;</code>
     *
     * @param CheckError[]|RepeatedField $var
     * @return $this
     */
    public function setCheckErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, CheckError::class);
    ...
    {
        GPBUtil::checkMessage($var, CheckResponse_CheckInfo::class);
        $this->check_info = $var;
