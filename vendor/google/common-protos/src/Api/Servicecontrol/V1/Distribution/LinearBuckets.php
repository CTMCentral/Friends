...
use Google\Api\Servicecontrol\V1\Distribution_LinearBuckets;
 ...
 */
class LinearBuckets extends Message
{
    /**
...
class_alias(LinearBuckets::class, Distribution_LinearBuckets::class);
