...
use Google\Api\Servicecontrol\V1\Distribution_ExponentialBuckets;
 ...
 */
class ExponentialBuckets extends Message
{
    /**
...
class_alias(ExponentialBuckets::class, Distribution_ExponentialBuckets::class);
