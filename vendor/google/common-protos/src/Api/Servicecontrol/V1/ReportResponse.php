...
use Google\Api\Servicecontrol\V1\ReportResponse\ReportError;
 ...
 */
class ReportResponse extends Message
{
    /**
     ...
     *
     *     @type ReportError[]|RepeatedField $report_errors
     *           Partial failures, one for each `Operation` in the request that failed
     *           processing. There are three possible combinations of the RPC status:
     *           1. The combination of a successful RPC status and an empty `report_errors`
     *              list indicates a complete success where all `Operations` in the
     ...
     * Generated from protobuf field <code>repeated .google.api.servicecontrol.v1.ReportResponse.ReportError report_errors = 1;</code>
     *
     * @param ReportError[]|RepeatedField $var
     * @return $this
     */
    public function setReportErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, ReportError::class);
