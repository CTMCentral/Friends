...
use Google\Api\Servicecontrol\V1\Distribution\ExplicitBuckets;
use Google\Api\Servicecontrol\V1\Distribution\ExponentialBuckets;
use Google\Api\Servicecontrol\V1\Distribution\LinearBuckets;
...
class Distribution extends Message
{
     ...
     *           where each x_i is a sample values. If `count` is zero then this field
     *           must be zero, otherwise validation of the request fails.
     *     @type int[]|string[]|RepeatedField $bucket_counts
     *           The number of samples in each histogram bucket. `bucket_counts` are
     *           optional. If present, they must sum to the `count` value.
     *           The buckets are defined below in `bucket_option`. There are N buckets.
     *           `bucket_counts[0]` is the number of samples in the underflow bucket.
     ...
     *           below for more details.
     *           Any suffix of trailing zeros may be omitted.
     *     @type LinearBuckets                $linear_buckets
     *           Buckets with constant width.
     *     @type ExponentialBuckets $exponential_buckets
     *           Buckets with exponentially growing width.
     *     @type ExplicitBuckets $explicit_buckets
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.Distribution.LinearBuckets linear_buckets = 7;</code>
     * @param LinearBuckets $var
     * @return $this
     */
    public function setLinearBuckets($var)
    {
        GPBUtil::checkMessage($var, Distribution_LinearBuckets::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.Distribution.ExponentialBuckets exponential_buckets = 8;</code>
     * @param ExponentialBuckets $var
     * @return $this
     */
    public function setExponentialBuckets($var)
    {
        GPBUtil::checkMessage($var, Distribution_ExponentialBuckets::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.Distribution.ExplicitBuckets explicit_buckets = 9;</code>
     * @param ExplicitBuckets $var
     * @return $this
     */
    public function setExplicitBuckets($var)
    {
        GPBUtil::checkMessage($var, Distribution_ExplicitBuckets::class);
