...
use Google\Api\Servicecontrol\V1\ReportResponse_ReportError;
 ...
 */
class ReportError extends Message
{
    /**
     * The
...
class_alias(ReportError::class, ReportResponse_ReportError::class);
