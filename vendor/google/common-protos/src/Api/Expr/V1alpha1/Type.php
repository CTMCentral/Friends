...
use Google\Api\Expr\V1alpha1\Type\AbstractType;
use Google\Api\Expr\V1alpha1\Type\FunctionType;
use Google\Api\Expr\V1alpha1\Type\ListType;
use Google\Api\Expr\V1alpha1\Type\MapType;
...
class Type extends Message
{
     ...
     *     @type AbstractType $abstract_type
    ...
    {
        GPBUtil::checkMessage($var, GPBEmpty::class);
    ...
    {
        GPBUtil::checkEnum($var, Type_PrimitiveType::class);
    ...
    {
        GPBUtil::checkEnum($var, Type_WellKnownType::class);
    ...
    {
        GPBUtil::checkMessage($var, Type_ListType::class);
    ...
    {
        GPBUtil::checkMessage($var, Type_MapType::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.Type.FunctionType function = 8;</code>
     * @param FunctionType $var
     * @return $this
     */
    public function setFunction($var)
    {
        GPBUtil::checkMessage($var, Type_FunctionType::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.Type.AbstractType abstract_type = 14;</code>
     * @param AbstractType $var
     * @return $this
     */
    public function setAbstractType($var)
    {
        GPBUtil::checkMessage($var, Type_AbstractType::class);
