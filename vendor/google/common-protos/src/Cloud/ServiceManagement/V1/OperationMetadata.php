...
use Google\Cloud\ServiceManagement\V1\OperationMetadata\Step;
...
class OperationMetadata extends Message
{
     ...
     *
     *     @type string[]|RepeatedField $resource_names
     *           The full name of the resources that this operation is directly
     *           associated with.
     *     @type Step[]|RepeatedField   $steps
     *           Detailed status information for each step. The order is undetermined.
     ...
     * Generated from protobuf field <code>repeated .google.api.servicemanagement.v1.OperationMetadata.Step steps = 2;</code>
     *
     * @param Step[]|RepeatedField $var
     * @return $this
     */
    public function setSteps($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, Step::class);
        $this->steps = $arr;
