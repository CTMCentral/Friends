...
use Google\Cloud\ServiceManagement\V1\Rollout_TrafficPercentStrategy;
 ...
 */
class TrafficPercentStrategy extends Message
{
    /**
     ...
     *
     *     @type array|MapField $percentages
     *           Maps service configuration IDs to their corresponding traffic percentage.
     *           Key is the service configuration ID, Value is the traffic percentage
     *           which must be greater than 0.0 and the sum must equal to 100.0.
     * }
...
class_alias(TrafficPercentStrategy::class, Rollout_TrafficPercentStrategy::class);
