...
use Google\Cloud\ServiceManagement\V1\Rollout_DeleteServiceStrategy;
 ...
 */
class DeleteServiceStrategy extends Message
{
...
class_alias(DeleteServiceStrategy::class, Rollout_DeleteServiceStrategy::class);
