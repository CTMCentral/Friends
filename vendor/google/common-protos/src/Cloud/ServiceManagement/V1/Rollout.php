...
use Google\Cloud\ServiceManagement\V1\Rollout\DeleteServiceStrategy;
use Google\Cloud\ServiceManagement\V1\Rollout\TrafficPercentStrategy;
...
class Rollout extends Message
{
     ...
     *           the system will automatically rollback to the current Rollout
     *           version. Readonly.
     *     @type TrafficPercentStrategy $traffic_percent_strategy
     *           Google Service Control selects service configurations based on
     *           traffic percentage.
     *     @type DeleteServiceStrategy $delete_service_strategy
    ...
    {
        GPBUtil::checkEnum($var, Rollout_RolloutStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy traffic_percent_strategy = 5;</code>
     * @param TrafficPercentStrategy $var
     * @return $this
     */
    public function setTrafficPercentStrategy($var)
    {
        GPBUtil::checkMessage($var, Rollout_TrafficPercentStrategy::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy delete_service_strategy = 200;</code>
     * @param DeleteServiceStrategy $var
     * @return $this
     */
    public function setDeleteServiceStrategy($var)
    {
        GPBUtil::checkMessage($var, Rollout_DeleteServiceStrategy::class);
