 ...
 */
class ConfigSource extends Message
{
    /**
     ...
     *           by the client for tracking purpose. If empty, the server may choose to
     *           generate one instead.
     *     @type ConfigFile[]|RepeatedField $files
     *           Set of source configuration files that are used to generate a service
     *           configuration (`google.api.Service`).
     * }
     */
     ...
     * Generated from protobuf field <code>repeated .google.api.servicemanagement.v1.ConfigFile files = 2;</code>
     *
     * @param ConfigFile[]|RepeatedField $var
     * @return $this
     */
    public function setFiles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, ConfigFile::class);
        $this->files = $arr;
