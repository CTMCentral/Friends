...
use Google\Cloud\ServiceManagement\V1\OperationMetadata_Status;
use Google\Cloud\ServiceManagement\V1\OperationMetadata_Step;
...
class Step extends Message
{
    ...
    {
        GPBUtil::checkEnum($var, OperationMetadata_Status::class);
        $this->status = $var;
...
class_alias(Step::class, OperationMetadata_Step::class);
