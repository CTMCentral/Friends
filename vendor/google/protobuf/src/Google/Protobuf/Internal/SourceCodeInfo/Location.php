...
class Location extends Message
{
     ...
     *     @type string[]|RepeatedField $leading_detached_comments
     * }
     */
...
class_alias(Location::class, SourceCodeInfo_Location::class);
