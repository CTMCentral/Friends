...
class UninterpretedOption extends Message
{
     ...
     *
     *     @type NamePart[]|\Google\Protobuf\Internal\RepeatedField $name
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.UninterpretedOption.NamePart name = 2;</code>
     * @param NamePart[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setName($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, NamePart::class);
        $this->name = $arr;
        $this->has_name = true;
