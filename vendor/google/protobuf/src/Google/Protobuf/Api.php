...
class Api extends Message
{
     ...
     *           The fully qualified name of this interface, including package name
     *           followed by the interface's simple name.
     *     @type Method[]|RepeatedField $methods
     *           The methods of this interface, in unspecified order.
     ...
     *           Source context for the protocol buffer service represented by this
     *           message.
     *     @type Mixin[]|RepeatedField $mixins
     *           Included interfaces. See [Mixin][].
     *     @type int                   $syntax
     *           The source syntax of the service.
     * }
     ...
     * Generated from protobuf field <code>repeated .google.protobuf.Method methods = 2;</code>
     *
     * @param Method[]|RepeatedField $var
     * @return $this
     */
    public function setMethods($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, Method::class);
        $this->methods = $arr;
     ...
     * Generated from protobuf field <code>repeated .google.protobuf.Mixin mixins = 6;</code>
     *
     * @param Mixin[]|RepeatedField $var
     * @return $this
     */
    public function setMixins($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, Mixin::class);
        $this->mixins = $arr;
